...
int main(int argc, char **argv) {
  ...
  // Will contain data from all of the servers
  clusteringData *server_cluster_data = createAlgoReqs(5);
  ...
  if (argc == 1) {
	...
	exit(1);
      ...
      doit(&server, server_cluster_data);
  }

  //printf("Printing the edges\n");
  //print_tree(server_cluster_data);
